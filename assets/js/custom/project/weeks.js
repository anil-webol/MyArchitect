var KTProjectOverview = (function () {
    var t = KTUtil.getCssVariableValue("--bs-theme-black"),
        ...
        a = KTUtil.getCssVariableValue("--bs-light"),
        r = KTUtil.getCssVariableValue("--bs-theme-light"),
    ...
    return {
        init: function () {
            var s, i;
            !(function () {
                var t = document.getElementById("project_progress_week");
                if (t) {
                    var e = t.getContext("2d");
                    new Chart(e, {
                        type: "doughnut",
                        data: { datasets: [{ data: [26, 23, 1, 12, 7], backgroundColor: ["#dbdfe9","#99a1b7","#4b5675", "#282728B",] }], labels: ["Preparation & Survey", "Design & Planning", "Technical & Tender", "Builder Chosen / Site-prep", "On-site / Project assistance"] },
                        options: {
